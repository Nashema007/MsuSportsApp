...
public class FirstTeamFemales extends Fragment implements RecyclerItemTouchHelperDeletePlayer.RecyclerItemTouchHelperListener {

    public FirstTeamFemales() {
    }
            ...
            snackbar.addCallback(new Snackbar.Callback() {
                ...
                public void onDismissed(Snackbar snackbar, int event) {
                    ...
                    if (event != Snackbar.Callback.DISMISS_EVENT_ACTION) {
                        ...
                        deleteFemalePlayers(name, sport);
                    }
    ...
    private void deleteFemalePlayers(String player, String extra) {
