...
public class MalePlayers extends Fragment implements RecyclerItemTouchHelper.RecyclerItemTouchHelperListener {
    ...
    private void addMalePlayers(String player, String extra) {
